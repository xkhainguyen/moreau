...
| <img src="assets/compressed_sensing.png" width="200"/> | [Compressed Sensing](notebooks/compressed_sensing.ipynb) | 1D sparse recovery via L1 basis pursuit and 2D image reconstruction from random projections — the single-pixel camera. | `CVXPY` `LP` |
